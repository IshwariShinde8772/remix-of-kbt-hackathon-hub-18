...
const MarqueeText = () => (
  <span className="text-amber-900 font-semibold text-sm md:text-base flex items-center gap-2 mx-8 shrink-0">
    ...
    Important Update: The last date for team registration has been extended to 5 April 2026!
  </span>
);
...
const MarqueeBanner = () => {
  return (
    <div className="bg-amber-100 py-3 overflow-hidden flex z-40 relative shadow-sm border-b border-amber-200">
      {/* 
