...
const steps = [
  ...
  { number: 5, title: "Last Date of Registration", description: "Final deadline for student teams to register for the hackathon.", date: "5 APR 2026" },
  ...
  { number: 7, title: "Scrutiny of Solutions", description: "Expert panel screens and evaluates the best solutions from all online video and ppt submissions (No need to come to college).", date: "11 APR 2026" },
  { number: 8, title: "Final Evaluation", description: "Shortlisted solutions are presented to industry experts for final evaluation. This will happen in college, so teams need to come to college.", date: "18 APR 2026" },
